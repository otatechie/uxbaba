# UX Guide report — https://www.airbnb.com/

**Goal:** book a place to stay next weekend
**Persona:** traveler on their phone
**Page:** Airbnb | Vacation rentals, cabins, beach houses, & more
...
- **H5 Error prevention** _(measured, medium)_
  ...
  - `div > div > div.tduirlf > button.sqsvdya`
  - _button 20×40px (min side 20px < 24, WCAG 2.2 SC 2.5.8)_

- **H5 Error prevention** _(measured, medium)_
  "Show more" is below the WCAG 2.2 minimum target size (24×24px). Increases mis-taps.
  - `#:r7:`
  - _button 90×18px (min side 18px < 24, WCAG 2.2 SC 2.5.8)_
...
- **H8 Aesthetic and minimalist design** _(measured, low)_
  ...
  - `body`
  - _59 interactive elements on one screen_
