# UX Guide report — https://www.apple.com/apple-vision-pro/

**Goal:** learn about Vision Pro and buy it
**Persona:** curious shopper on their phone
**Page:** Apple Vision Pro - Apple
...
- **H4 Consistency and standards** _(measured, medium)_ — **21 elements share this** (e.g. li.gallery-item > div.card-item > div.card-copy > p, li.gallery-item > div.card-item > div.card-copy > p, li.gallery-item > div.card-item > div.card-copy > p)
  Text "Apple Vision Pro is the result…" fails WCAG 2.2 SC 1.4.3 contrast (normal-text threshold). Computed, not guessed.
  - _contrast 3.62:1 (WCAG AA needs 4.5:1 for normal text)_
...
- **H8 Aesthetic and minimalist design** _(measured, low)_
  ...
  - `body`
  - _100 interactive elements on one screen_
...
- **Partial capture.** Only the first 400 of 408+ visible elements were scanned. Whole-page checks (help, interactive density) saw the top of the page only and may be incomplete. Findings on captured elements remain valid.
