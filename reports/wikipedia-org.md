# UX Guide report — https://www.wikipedia.org/

**Goal:** search for an article
**Persona:** visitor
**Page:** Wikipedia
...
- **H8 Aesthetic and minimalist design** _(measured, low)_
  ...
  - `body`
  - _33 interactive elements on one screen_
...
- **Full capture.** All 78 visible elements on the page were scanned.
