...
- **H4 Consistency and standards** _(measured, medium)_ — **3 elements share this** (e.g. div.col-lg-5 > div.foot-link > p > a, div.col-lg-5 > div.foot-link > p > a, div.foot-link > ul > p > a)
  Text "info@mlar.org…" fails WCAG 2.2 SC 1.4.3 contrast (normal-text threshold). Computed, not guessed.
  - _contrast 4.04:1 (WCAG AA needs 4.5:1 for normal text)_
