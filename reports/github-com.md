# UX Guide report — https://github.com/

**Goal:** sign up
**Persona:** dev
**Page:** GitHub · Change is constant. GitHub keeps you ahead. · GitHub
...
- **H5 Error prevention** _(measured, medium)_
  "MANAGE COOKIES" is below the WCAG 2.2 minimum target size (24×24px). Increases mis-taps.
  - `ul.SubFooter-module__legalList__W482t > li > cookie-consent-link > button.SubFooter-module__cookieButton__Wslda`
  - _button 104×18px (min side 18px < 24, WCAG 2.2 SC 2.5.8)_

- **H5 Error prevention** _(measured, medium)_
  "DO NOT SHARE MY PERSONAL INFORMATION" is below the WCAG 2.2 minimum target size (24×24px). Increases mis-taps.
  - `ul.SubFooter-module__legalList__W482t > li > cookie-consent-link > button.SubFooter-module__cookieButton__Wslda`
  - _button 267×18px (min side 18px < 24, WCAG 2.2 SC 2.5.8)_
...
- **H8 Aesthetic and minimalist design** _(measured, low)_
  ...
  - `body`
  - _95 interactive elements on one screen_
