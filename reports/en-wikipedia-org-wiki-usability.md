# UX Guide report — https://en.wikipedia.org/wiki/Usability

**Goal:** learn usability
**Persona:** student
**Page:** Usability - Wikipedia
...
- **H8 Aesthetic and minimalist design** _(measured, low)_
  ...
  - `body`
  - _162 interactive elements on one screen_
...
- **Partial capture.** Only the first 400 of 1165+ visible elements were scanned. Whole-page checks (help, interactive density) saw the top of the page only and may be incomplete. Findings on captured elements remain valid.
